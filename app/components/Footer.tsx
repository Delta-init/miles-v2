...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/milescap",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/miles-capital",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "X / Twitter",
    href: "https://twitter.com/milescap",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/milescap",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-3 mt-4">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-8 h-8 rounded-full border border-border flex items-center justify-center text-muted hover:text-foreground hover:border-accent/50 transition-colors"
                >
                  {s.icon}
                </a>
              ))}
